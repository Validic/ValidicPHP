<?php
/**
 * Biometrics endpoint for the Validic API.
 *
 * PHP version 5
 *
 ...
 * @author Aleksandar Jocic <aleks.jocic@validic.com>
 */
class BiometricsEndpoint extends Endpoint
{

    /**
     * Constructs a biometrics endpoint.
     * 
     * @param array $options
    ...
    {
        parent::__construct(Endpoints::BIOMETRICS, $options);
    }
}