<?php
/**
 * User's profile endpoint for the Validic API.
 *
 * PHP version 5
 *
 ...
 * @author Aleksandar Jocic <aleks.jocic@validic.com>
 */
class ProfileEndpoint extends ShortEndpoint
{

    /**
     * Constructs a user's profile endpoint.
     * 
     * @param array $options
    ...
    {
        parent::__construct(ShortEndpoints::PROFILE, $options);
    }
}