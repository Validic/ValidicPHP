<?php
/**
 * Apps endpoint for the Validic API.
 *
 * PHP version 5
 *
...
/**
 * Apps endpoint is intended to retrieve an organization's avalilable apps.
 * Providing a user id does work but is deprecated.
 *
 * @author Aleksandar Jocic <aleks.jocic@validic.com>
 */
